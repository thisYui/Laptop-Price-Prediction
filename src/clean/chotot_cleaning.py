...
CONFIG: dict[str, Any] = {
    ...
    "report_path": PROJECT_ROOT / "data" / "intern" / "chotot_cleaning_report.csv",
    "issue_action_plan_path": PROJECT_ROOT / "data" / "intern" / "chotot_issue_action_plan.csv",
    "log_path": PROJECT_ROOT / "data" / "intern" / "chotot_cleaning_log.json",
    "price_min": 1_000_000,
