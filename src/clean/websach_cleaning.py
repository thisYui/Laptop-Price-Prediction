...
CONFIG: dict[str, Any] = {
    ...
    "report_path": PROJECT_ROOT / "data" / "intern" / "websach_cleaning_report.csv",
    "issue_action_plan_path": PROJECT_ROOT / "data" / "intern" / "websach_issue_action_plan.csv",
    "log_path": PROJECT_ROOT / "data" / "intern" / "websach_cleaning_log.json",
