...
\newcommand{\tenmonhoc}{CSC14005 -- Xây dựng và Triển khai Hệ thống Học máy Ứng dụng}
...
\newcommand{\hovatenGV}{[Giảng viên hướng dẫn]}
...
\newpage
\input{sections/03-data-cleaning}

\newpage
\input{sections/04-data-quality}

\newpage
\input{sections/05-data-management}

\newpage
\input{sections/06-eda}
